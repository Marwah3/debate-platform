...
export default function AdminLandingPage() {
  ...
  const [activeTab, setActiveTab] = useState<'stats' | 'berita' | 'prestasi'>('stats');
  ...
  // 5. Hapus Item
  const handleHapusItem = async (type: 'berita' | 'prestasi', id: number) => {
  ...
  return (
    <div className="space-y-8 animate-fadeIn text-[#334F70]">
      ...
      {/* Navigasi Tab */}
      <div className="flex space-x-2 bg-[#F3F3F4] p-1.5 rounded-2xl w-fit border border-[#C8D8E8]">
        <button
            ...
            <form onSubmit={handleSaveStats} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-[#F3F3F4] border border-[#C8D8E8] rounded-xl focus:outline-hidden focus:border-[#334F70] text-sm font-medium transition"
                />
              </div>
            ...
            <form onSubmit={handleTambahBerita} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-24 p-3 bg-[#F3F3F4] border border-[#C8D8E8] rounded-xl focus:outline-hidden focus:border-[#334F70] text-sm font-medium placeholder-slate-400 leading-relaxed transition"
                />
              </div>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-[#F3F3F4] text-sm font-medium">
                    {beritaData.map((item, index) => (
                      <tr key={item.id_berita} className="hover:bg-slate-50/80 transition duration-150">
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-[#F3F3F4] text-sm font-medium">
                    {prestasiData.map((item, index) => (
                      <tr key={item.id_prestasi} className="hover:bg-slate-50/80 transition duration-150">
                        <td className="p-4 pl-6 text-center text-slate-400 font-bold">{index + 1}</td>
                        <td className="p-4">
